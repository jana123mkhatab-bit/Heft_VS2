...
The Merge algorithm (implemented in \texttt{merge.cpp}) is a hybrid
strategy that integrates D\&C decomposition, DP look-ahead, and
EDP-style global assignment in one adaptive pipeline.
Its role is to improve schedule quality over local heuristics while
retaining practical runtime on moderate DAG sizes.
