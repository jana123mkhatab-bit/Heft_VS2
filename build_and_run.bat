...
cl /EHsc /W3 /I. /Imodels /Icore /Iutils main.cpp core\dac.cpp core\dp.cpp core\Edp.cpp core\heft.cpp core\merge.cpp utils\dag_generator.cpp /Fe:HeftProject.exe
